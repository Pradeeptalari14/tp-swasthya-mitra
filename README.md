# 🩺 Swasthya Mitra (Rural Health Companion)

> Offline symptom checker for remote clinics. Exports diagnosis summaries to WhatsApp API.
...
## 🎛️ How It Works
Open the **[Interactive Studio](https://pradeeptalari14.github.io/portfolio/tools/swasthya-mitra/)** in your portfolio dashboard to customize options, select webhook notification channels (Slack/Teams), toggle chat bot connections (WhatsApp Business/Telegram Bot), and download compiled deployment scripts dynamically.
...
```bash
git clone https://github.com/Pradeeptalari14/tp-swasthya-mitra.git
cd tp-swasthya-mitra
```
...
```bash
kubectl port-forward deployment/tp-swasthya-mitra 8080:8080 || echo "Port forwarding enabled on localhost:8080"
```
...
└── primary_config/
    └── swasthya_mitra.py     # Main configuration file
```
...
---
*Generated by [Swasthya Mitra (Rural Health Companion) Studio](https://pradeeptalari14.github.io/portfolio/tools/swasthya-mitra/) — [Talari Pradeep SRE Portfolio](https://pradeeptalari14.github.io/portfolio)*
